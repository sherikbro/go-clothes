...
import { WorkersModal } from "@components";
...
const Index = () => {
    ...
    const deleteData =async(id)=>{
        const res = await workers.delete(id)
        if (res.status === 200) {
  ...
  return (
    <div className="w-full pb-[50px] bg-sky-100 ">
      ...
      <WorkersModal open={open} toggle={() => setOpen(false)} data={data} />
          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead>
              <TableRow className="bg-slate-200">
                ...
                <TableCell align="center"><h1 className="font-bold text-[20px]">First name</h1></TableCell>
                <TableCell align="center"><h1 className="font-bold text-[20px]">Last name</h1></TableCell>
                <TableCell align="center"><h1 className="font-bold text-[20px]">email</h1></TableCell>
                <TableCell align="center"><h1 className="font-bold text-[20px]">number</h1></TableCell>
                <TableCell align="center"><h1 className="font-bold text-[20px]">gender</h1></TableCell>
                <TableCell align="center"><h1 className="font-bold text-[20px]">age</h1></TableCell>
                <TableCell align="center">
